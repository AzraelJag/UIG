...
public class AccountItemTableView {
	
	public static TableView getAccountItemTableView(ObservableList<AccountItemList> accountItemList, String accountId) {
		
		final Label label = new Label(accountId + " Itemliste:");
